...
const Blogs = () => {
    return (
        <div className='grid grid-cols-2 gap-10 container mx-auto pt-12'>
            <div className='shadow-xl p-4 border-2'>
                <h1 className='text-4xl font-mono p-4'>Why i'm using firebase?</h1>
            ...
            <div className='shadow-xl p-4 border-2'>
                <h1 className='text-4xl font-mono p-4'>What other options do you have to implement authentication?</h1>
                <div className='text-lg font-mono'>
            ...
            <div className='shadow-xl p-4 border-2'>
                <h1 className='text-4xl font-mono p-4'>What other services does firebase provide other than authentication</h1>
                <div className='text-lg font-mono'>
            ...
            <div className='shadow-xl p-4 border-2'>
                <h1 className='text-4xl font-mono p-4'> Difference between authorization and authentication</h1>
                <div className='text-lg font-mono'>
